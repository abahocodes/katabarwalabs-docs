...
- [Agent Dispatch for Jira](./agent-dispatch.md) — one-click dispatch of a Jira work item to your AI coding agent running in your own CI; the pull request comes back to the issue.
